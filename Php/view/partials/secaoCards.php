<div class="bg-blue-950 p-8 mb-10">
...
<p class="text-4xl text-center font-bold text-blue-900 my-20">Eventos e Palestras</p>

<div class="grid grid-cols-1 space-y-4 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3  max-w-screen-lg mx-auto gap-5 mb-20">
                ...
                <div class="p-5">
                    ...
                    <?php if ($controller == "dashboard" || $controller == "eventos"): ?>
                        <form action="ver-evento" method="post">
                            ...
                            <button type="submit" class="btn btn-neutral mt-5">Saber Mais</button>
                        </form>
                    <?php endif; ?>
